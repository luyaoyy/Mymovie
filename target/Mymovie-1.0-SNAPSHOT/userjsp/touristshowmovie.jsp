...
<%@ page import="service.CommentAndUserServiceImpl" %>
<%@ page import="java.sql.SQLException" %>
<%@ page import="bean.CommentAndUser" %>
...
<%
    ...
    if (mid != null) {
        ...
        try {
            pageContext.setAttribute("movie", movieService.selectMovieByid(Integer.valueOf(mid)));
            List<CommentAndUser> comments=commentAndUserService.queryBymid(Integer.valueOf(mid));
            if(comments.size()==0){
                pageContext.setAttribute("comments", null);
            }else {
...
<div id="big">
    <div id="mid">
        <div id="img"><img src="${pageScope.movie.mimg}" title="${pageScope.movie.mname}"></div>
        <div id="info">
            <h1>${pageScope.movie.mname}</h1>
            <hr>
...
<div id="introduce">
    ...
    <p>${pageScope.movie.mintroduce}</p>
</div>
<div id="comment">
    <h2>用户评论</h2>
    <c:choose>
        <c:when test="${pageScope.comments!=null}">
            <div>
