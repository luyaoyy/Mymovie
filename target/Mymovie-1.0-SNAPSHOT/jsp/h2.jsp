...
<div id="right">
    <nav id="nav">
        <ul>
            <li id="now"><a href="">全部</a></li>
            <li><a href="/login/SelectActionMovieServlet">动作</a></li>
            <li><a href="/login/SelectComedyMovieServlet?mclass=喜剧">喜剧</a></li>
            <li><a href="/login/SelectScienceMovieServlet?mclass=科幻">科幻</a></li>
            <li><a href="/login/SelectLoveMovieServlet?mclass=爱情">爱情</a></li>
            <li><a href="/login/SelectTerrorMovieServlet?mclass=动作">恐怖</a></li>
            ...
            <div id="out">
                <c:forEach items="${requestScope.movies}" var="movie">
                    <div id="movie_card">
                        ...
                        <div><div id="edit"><a href="/login/EditMovieGetMovieServlet?id=${movie.id}">编辑</a></div><div id="dele"><a href="/login/jsp/h2.jsp?mid=${movie.id}" onclick="return confirm('是否确认将此电影下架?')">下架</a></div></div>
                    </div>
                </c:forEach>
            </div>
    <div id="bottom">
        ...
        <c:choose>
            ...
            <c:otherwise>
                <a href="/login/H2Servlet?pageIndex=${requestScope.pageResult.pageIndex-1}">上一页</a>
            </c:otherwise>
        </c:choose>
        ...
        <c:choose>
            ...
            <c:otherwise>
                <a href="/login/H2Servlet?pageIndex=${requestScope.pageResult.pageIndex+1}">下一页</a>
            </c:otherwise>
        </c:choose>
    </div>
</div>
