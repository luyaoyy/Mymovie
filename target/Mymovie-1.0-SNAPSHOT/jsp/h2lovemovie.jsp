...
<%
    ...
    if (mid_str!=null){
        ...
        if (row>0){
            ...
            response.sendRedirect("/login/SelectLoveMovieServlet");
        }
    }
%>
<body>
...
<div id="right">
    <nav id="nav">
        <ul>
            ...
            <li id="now"><a href="/login/SelectLoveMovieServlet?mclass=爱情">爱情</a></li>
    ...
    <div id="out">
        <c:forEach items="${sessionScope.lovemovie}" var="movie">
            <div id="movie_card">
                ...
                <div><div id="edit"><a href="/login/EditMovieGetMovieServlet?id=${movie.id}">编辑</a></div><div id="dele"><a href="/login/jsp/h2lovemovie.jsp?mid=${movie.id}" onclick="return confirm('是否确认将此电影下架?')">下架</a></div></div>
            </div>
        </c:forEach>
    </div>
</div>
