...
<%
    ...
    if (mid_str!=null){
        ...
        if (row>0){
            ...
            response.sendRedirect("/login/SelectScienceMovieServlet");
        }
    }
%>
<body>
...
<div id="right">
    <nav id="nav">
        <ul>
            ...
            <li id="now"><a href="/login/SelectScienceMovieServlet?mclass=科幻">科幻</a></li>
    ...
    <div id="out">
        <c:forEach items="${sessionScope.sciencemovie}" var="movie">
            <div id="movie_card">
                ...
                <div><div id="edit"><a href="/login/EditMovieGetMovieServlet?id=${movie.id}">编辑</a></div><div id="dele"><a href="/login/jsp/h2sciencemovie.jsp?mid=${movie.id}" onclick="return confirm('是否确认将此电影下架?')">下架</a></div></div>
            </div>
        </c:forEach>
    </div>
</div>
