    ...
    <div id="content">
        ...
        <div id="bottom">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/login/HomeServlet?pageIndex=${requestScope.pageResult.pageIndex-1}">上一页</a>
                </c:otherwise>
            </c:choose>

            <c:forEach begin="1" end="${requestScope.pageResult.pageNum}" varStatus="status">
                <a href="/login/HomeServlet?pageIndex=${status.index}">${status.index}</a>
            </c:forEach>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="/login/HomeServlet?pageIndex=${requestScope.pageResult.pageIndex+1}">下一页</a>
                </c:otherwise>
            </c:choose>
            <form action="/login/HomeServlet" method="get">
