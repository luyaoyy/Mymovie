...
<div class="img_content">
    <div class="item" style="display: block;"><a href="/login/ShowMovieServlet?mid=132"><img
            src="${pageContext.request.contextPath}/img/人生大事.jpg" alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid=169"><img src="${pageContext.request.contextPath}/img/暗恋.jpg"
                                                                     alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid=130"><img
            src="${pageContext.request.contextPath}/img/你的名字.jpeg" alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid=186"><img
            src="${pageContext.request.contextPath}/img/月球陨落.jpg" alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid=185"><img src="${pageContext.request.contextPath}/img/烈探.jpg"
                                                                     alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid="><img src="${pageContext.request.contextPath}/img/暗恋.jpg"
                                                                  alt=""></a></div>
    <div class="item"><a href="/login/ShowMovieServlet?mid="><img src="${pageContext.request.contextPath}/img/暗恋.jpg"
                                                                  alt=""></a></div>
</div>
    ...
    <div id="content">
        <div id="nav">
            <ul>
                ...
                <li class="now"><a href="/login/UserSelectMovieByNameServlet?mclass=喜剧">喜剧</a></li>
                ...
                <li><a href="/login/UserSelectMovieByNameServlet?mclass=动画">动画</a></li>
            </ul>
        </div>
        <div id="show">
