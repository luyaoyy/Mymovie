...
<div id="out">
    ...
    <form>
        <input type="text" value="${pageScope.tid}" hidden name="tid" >
        <input type="text" value="${pageScope.uid}" hidden name="uid" >
        ...
        <input type="submit" id="cancel" value="我已支付" formaction="/login/PayMoneyServlet" formmethod="get" style="background-color: cornflowerblue;margin-left: 12px" onclick="return confirm('支付成功,祝您观影愉快')">
    </form>
</div>
