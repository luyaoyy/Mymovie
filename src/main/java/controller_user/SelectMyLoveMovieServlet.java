...
@WebServlet("/SelectMyLoveMovieServlet")
public class SelectMyLoveMovieServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            request.setAttribute("movies",myLoveMovieService.selectLoveMovieByUid(Integer.valueOf(uid_str)));
